...
def parse_args():
    ...
    Example useage:
        python file_watch.py -d -env prod -job <job_name>
    ...
    parser.add_argument(
        ...
        dest="job_name",
        required=True,
        help="job_name file without .yml extension",
    )
    parser.add_argument(
        "-env", dest="environment", help="runtime environment [DEV | UAT | PROD ]"
    )
    parser.add_argument(
        "-d",
        "--debug",
...
def main():
    ...
    try:
        ...
        log.info("........................................................")
        log.info(
            f"<<<<< File Watcher Job ({args.job_name}) -- Started at ( {str_now()} ) >>>>> "
        )
        log.info("........................................................")
