...
DELETE FROM file_watch_config WHERE app_id='TEST'
SELECT * FROM file_watch_config WHERE app_id='TEST'

-- test_1: Test local path, single file
insert file_watch_config (job_name, app_id, job_description, file_names, file_count, source_path, sleep_time,look_time)
...
insert file_watch_config (job_name, app_id, job_description, file_names, file_count, source_path, sleep_time,look_time, use_copy, target_path)
...
insert file_watch_config (job_name, app_id, job_description, file_names, file_count, source_path, sleep_time,look_time, use_copy, target_path, use_archive, archive_path)
...
insert file_watch_config (job_name, app_id, job_description, file_names, file_count, source_path, sleep_time,look_time, min_size)
...
insert file_watch_config (job_name, app_id, job_description, file_names, file_count, source_path, sleep_time,look_time, exclude_age)
