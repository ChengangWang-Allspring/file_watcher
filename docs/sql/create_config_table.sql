...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[file_watch_config]') AND type IN (N'U'))
DROP TABLE [dbo].[file_watch_config]
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[file_watch_calendar]') AND type IN (N'U'))
DROP TABLE [dbo].[file_watch_calendar]
GO
